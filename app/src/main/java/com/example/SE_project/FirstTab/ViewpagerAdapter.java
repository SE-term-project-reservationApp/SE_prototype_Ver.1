    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, @SuppressLint("RecyclerView") int position) {
        ...
        viewHolder.match.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ReservationItem b=new ReservationItem(items.get(position).getName(),items.get(position).getAdress(),items.get(position).getTime(),items.get(position).getTeam(),items.get(position).getUri());
