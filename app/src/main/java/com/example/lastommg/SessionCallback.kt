...
import com.example.lastommg.Login.LoginActivity1
...
class SessionCallback(val context: LoginActivity1) : ISessionCallback {
            ...
            override fun onSuccess(result: MeV2Response?) {
                if (result != null) {
                    ...
                    context.getFirebaseJwt(accessToken).continueWithTask { task ->
                        ...
                        auth.signInWithCustomToken(firebaseToken!!) }.addOnCompleteListener { task ->
